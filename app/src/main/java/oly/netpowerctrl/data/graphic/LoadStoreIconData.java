...
//    }
    ...
    public static void show_select_icon_dialog(final Context context, String assetSet,
        ...
        if (callback_context_object instanceof Executable) {
            Executable oi = (Executable) callback_context_object;
...
//            this.file = file;
//            this.uid = UUID.fromString(file.getName().replace(".jpg", "").replace(".png", ""));
...
//            return state.name() + File.pathSeparator + uid.toString() + "." + extension;
//        }
//
//        @Override
