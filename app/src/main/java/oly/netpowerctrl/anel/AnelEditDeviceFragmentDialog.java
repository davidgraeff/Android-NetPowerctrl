...
public class AnelEditDeviceFragmentDialog extends DialogFragment implements AnelCreateDevice.AnelCreateDeviceResult {
    final AnelCreateDevice anelCreateDevice;

    public AnelEditDeviceFragmentDialog() {
        anelCreateDevice = ((AnelPlugin) ListenService.getService().getPluginByID(AnelPlugin.PLUGIN_ID)).anelCreateDevice;
    ...
    private void saveAndFinish() {
        ...
        AppData.getInstance().addToConfiguredDevices(getActivity(), anelCreateDevice.device);
        dismiss();
    }
