...
public class Executable implements Comparable, IOInterface {
    ...
    public boolean executionInProgress() {
        ...
        return last_command_timecode > credentials.getPlugin().getUpdatedTime(this);
    }
    ...
    public String getDescription() {
        return credentials.getPlugin().getDeviceName(this);
    }

    public ReachabilityStates reachableState() {
        return credentials.getPlugin().getReachableState(this);
    }
